...
export default function AppLayout({ children, title }: {
    ...
    <div className="grid grid-cols-6 min-h-screen font-mono text-sm grid-flow-row">
        ...
        <div className="flex flex-col row-span-4 p-2 bg-gradient-to-t from-slate-300 to-white via-white object-fill">
        ...
        <div className="flex flex-col col-span-4 row-span-4 p-2 flex bg-gradient-to-t from-slate-300 to-white via-white object-fill">
          ...
          <div className="flex place-items-center justify-center w-full pb-10">
            {children}
          </div>
        </div>
        ...
        <div className="flex row-span-4 p-2 bg-gradient-to-t from-slate-300 to-white via-white object-fill">
          {/*<div>Right Aside</div>*/}
        </div>
