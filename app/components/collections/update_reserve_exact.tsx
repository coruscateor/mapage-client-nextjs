...
export default function UpdateReserveExact({typeInfo, keyState, keyTypeInfo, resultRows}: {typeInfo: StoredTypeInfo, keyState: string, keyTypeInfo: StoredTypeInfo, resultRows: number})
{

    const label = `${typeInfo.lcTypeName}UpdateReserveExact`

    const mutation = `mutation UpdateReserveExact($key: ${keyTypeInfo.gqlTypeName}!, $additional: Int!) {
