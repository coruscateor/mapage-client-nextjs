...
export default function UpdateTryReserveExact({typeInfo, keyState, keyTypeInfo, resultRows}: {typeInfo: StoredTypeInfo, keyState: string, keyTypeInfo: StoredTypeInfo, resultRows: number})
{

    const label = `${typeInfo.lcTypeName}UpdateTryReserveExact`

    const mutation = `mutation UpdateTryReserveExact($key: ${keyTypeInfo.gqlTypeName}!, $additional: Int!) {
