...
export default function UpdatePush({typeInfo, keyState, keyTypeInfo, resultRows, itemTypeInfo}: {typeInfo: StoredTypeInfo, keyState: string, keyTypeInfo: StoredTypeInfo, resultRows: number, itemTypeInfo: StoredTypeInfo})
{

    const label = `${typeInfo.lcTypeName}UpdatePush`

    const mutation= `mutation UpdatePush($key: ${keyTypeInfo.gqlTypeName}!, $value: ${itemTypeInfo.gqlTypeName}!) {
