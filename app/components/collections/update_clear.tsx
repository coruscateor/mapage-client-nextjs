...
export default function UpdateClear({typeInfo, keyState, keyTypeInfo, resultRows}: {typeInfo: StoredTypeInfo, keyState: string, keyTypeInfo: StoredTypeInfo, resultRows: number})
{

    const label = `${typeInfo.lcTypeName}UpdateClear`

    const mutation = `mutation UpdateClear($key: ${keyTypeInfo.gqlTypeName}!) {
        ${label}(key: $key)
    }`
