...
export default function UpdateRotateLeft({typeInfo, keyState, keyTypeInfo, resultRows}: {typeInfo: StoredTypeInfo, keyState: string, keyTypeInfo: StoredTypeInfo, resultRows: number})
{

    const label = `${typeInfo.lcTypeName}UpdateRotateLeft`

    const mutation = `mutation UpdateRotateLeft($key: ${keyTypeInfo.gqlTypeName}!, $mid: Int!) {
