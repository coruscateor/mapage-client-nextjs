...
export default function UpdateShrinkToFit({typeInfo, keyState, keyTypeInfo, resultRows}: {typeInfo: StoredTypeInfo, keyState: string, keyTypeInfo: StoredTypeInfo, resultRows: number})
{

    const label = `${typeInfo.lcTypeName}UpdateShrinkToFit`

    const mutation = `mutation UpdateShrinkToFit($key: ${keyTypeInfo.gqlTypeName}!) {
        ${label}(key: $key)
    }`
