...
export default function UpdateTryReserve({typeInfo, keyState, keyTypeInfo, resultRows}: {typeInfo: StoredTypeInfo, keyState: string, keyTypeInfo: StoredTypeInfo, resultRows: number})
{

    const label = `${typeInfo.lcTypeName}UpdateTryReserve`

    const mutation = `mutation UpdateTryReserve($key: ${keyTypeInfo.gqlTypeName}!, $additional: Int!) {
