...
export default function UpdateSort({typeInfo, keyState, keyTypeInfo, resultRows}: {typeInfo: StoredTypeInfo, keyState: string, keyTypeInfo: StoredTypeInfo, resultRows: number})
{

    const label = `${typeInfo.lcTypeName}UpdateSort`

    const mutation = `mutation UpdateSort($key: ${keyTypeInfo.gqlTypeName}!) {
        ${label}(key: $key)
    }`
