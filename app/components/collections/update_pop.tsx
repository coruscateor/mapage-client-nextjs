...
export default function UpdatePop({typeInfo, keyState, keyTypeInfo, resultRows}: {typeInfo: StoredTypeInfo, keyState: string, keyTypeInfo: StoredTypeInfo, resultRows: number})
{

    const label = `${typeInfo.lcTypeName}UpdatePop`

    const mutation = `mutation UpdatePop($key: ${keyTypeInfo.gqlTypeName}!) {
        ${label}(key: $key)
    }`
