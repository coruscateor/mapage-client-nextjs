...
export default function BitXorOp({typeInfo, keyState, keyTypeInfo, resultRows}: {typeInfo: StoredTypeInfo, keyState: string, keyTypeInfo: StoredTypeInfo, resultRows: number})
{

    const label = `${typeInfo.lcTypeName}BitOrOp`

    const mutation = `mutation BitOrOp($key: ${keyTypeInfo.gqlTypeName}!) {
